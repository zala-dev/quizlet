define([
  ...
  "models/random",
], function (app, system, observable, service, random) {
  var module = {
    name: "",
    cards: [],
    card: {},
  ...
  module.nextIndex = function () {
    if (module.random) return random.pickRandom(module.cards);

    if (module.index < module.cards.length - 1) return module.index + 1;
